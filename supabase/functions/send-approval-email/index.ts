/**
 * FOD Rooms — Edge Function: send-approval-email
 *
 * Sends an approval confirmation email to the BOOKER
 * after an admin approves their booking. Uses Gmail SMTP.
 *
 * Expected POST body:
 *   { booking, roomName }
 *
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const subject = `✅ Booking Approved: ${roomName} on ${booking.date ?? ""}`;
      ...
      <tr>
        <td align="center" style="padding: 24px 0;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 560px; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
            <tr>
              <td style="background-color: #155724; background: linear-gradient(135deg,#155724,#28a745); color: #ffffff; padding: 20px 24px;">
                <h2 style="margin: 0; font-size: 20px; color: #ffffff; font-family: 'Segoe UI',Arial,sans-serif;">Booking Approved ✅</h2>
              </td>
            </tr>
            <tr>
              <td style="padding: 24px; font-family: 'Segoe UI',Arial,sans-serif; color: #1a1a2e; font-size: 14px; line-height: 1.5;">
                ...
                <p style="margin-top: 16px; margin-bottom: 16px; font-size: 14px; line-height: 1.5;">
                  <table border="0" cellspacing="0" cellpadding="0" style="display: inline-block; border-collapse: separate;">
                    <tr>
                      <td align="center" valign="middle" style="background-color: #d4edda; color: #155724; font-family: 'Segoe UI',Arial,sans-serif; font-size: 13px; font-weight: 600; padding: 4px 12px; border-radius: 20px;">
                        APPROVED
                      </td>
                    </tr>
                  </table>
                </p>
                <p style="margin-top: 16px; margin-bottom: 16px; font-size: 14px; line-height: 1.5;">Your booking was approved by <strong>${adminName || "an administrator"}</strong>.</p>
                <p style="margin-top: 16px; margin-bottom: 16px; font-size: 14px; line-height: 1.5;">Your room has been reserved. If you need to cancel, please contact the administrator directly.</p>
              </td>
            </tr>
            <tr>
